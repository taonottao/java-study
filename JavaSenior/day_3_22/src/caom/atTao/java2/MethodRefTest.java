...
public class MethodRefTest {
	...
	public void test4() {
		...
		System.out.println(f1.apply(12.6));

		System.out.println("************************");

		Function<Double,Long> f2 = Math::round;
		System.out.println(f2.apply(12.3));
	...
	public void test5() {
		...
		System.out.println(c2.compare("cad", "cas"));
	...
	public void test6() {
		...
		System.out.println(b2.test("abc", "abd"));
	}
