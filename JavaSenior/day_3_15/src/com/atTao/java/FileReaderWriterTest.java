...
public class FileReaderWriterTest {
    ...
    public static void main(String[] args) {
        ...
        File file1 = new File("day_3_15\\hello.txt");
        System.out.println(file1.getAbsolutePath());
    }

    /*
    将day_3_15下的hello.txt文件内容读取入程序中，并输出到控制台

    说明点：
    1.read()的理解:返回读入的字符。如果达到文件末尾，返回-1
    2.异常的处理：为了保证流资源一定可以执行关闭的操作需要使用try-catch-finally处理
